...
<body class="bg-light">
    <nav class="navbar bg-white fixed-top navbar-expand-md box-shadow navbar-light">
        <a class="navbar-brand h1 mb-0" href="{{ url('/') }}">
            <img src="{{ asset('img/logo.svg') }}" width="30" height="30" class="d-inline-block align-top" alt="logo"> Eventually
        </a>
    ...
    <footer class="footer container py-5">
        <div class="row">
            <div class="col-sm">
                <small class="d-block mb-3 text-muted">Eventually &copy; 2018</small>
            </div>
            <div class="col">
                <h5>Resources</h5>
