            ...
            <div class="col-md-5 ">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item p-0 pt-0 pb-0">
                            <div class="media m-2">
                                <img class="d-flex m-auto rounded-circle" src="@if($friend->image) {{ Storage::url($friend->image) }} @else {{ asset('img/person_placeholder.png') }} @endif" alt="Friend's profile picture" style="width: 32px; height: 32px;">
                                <div class="media-body mb-0">
